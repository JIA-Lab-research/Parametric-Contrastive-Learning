...
**The checkpoint download links on this page have expired. Pretrained models are available at Hugging Face (https://huggingface.co/jiequan/Parametric-Contrastive-Learning/tree/main)**
